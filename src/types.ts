export const BLEND_MODE = {
  ...
  export type CreateLayerOperation = { type: "CREATE_LAYER"; payload: AddLayerPayload };
  export type RemoveLayerOperation = { type: "REMOVE_LAYER"; payload: RemoveLayerPayload };
  export type UpdateLayerOperation = { type: "UPDATE_LAYER"; payload: UpdateLayerPayload };
  export type SetSelectedLayerOperation = { type: "SET_SELECTED_LAYER"; payload: SetSelectedLayerPayload };
  export type SetZoomOperation = { type: "SET_ZOOM"; payload: SetZoomPayload };
  export type SetPanOffsetOperation = { type: "SET_PAN_OFFSET"; payload: SetPanOffsetPayload };
  export type SetCanvasDimensionsOperation = { type: "SET_CANVAS_DIMENSIONS"; payload: SetCanvasDimensionsPayload };
  export type CreateGroupOperation = { type: "CREATE_GROUP"; payload: CreateGroupPayload };
  ...
  export type SetCanvasDimensionsPayload = { dimensions: { width: number; height: number } };
  ...
  export type OperationWithPayload = Exclude<Operation, { type: typeof OPERATION.UNDO | typeof OPERATION.REDO }>;
  export type OperationPayload<T extends OperationType> = Extract<OperationWithPayload, { type: T }>['payload'];
